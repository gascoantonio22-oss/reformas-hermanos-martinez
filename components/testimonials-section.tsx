...
const testimonials = [
  {
    ...
    text: "Nos reformaron la cocina y desde el principio supimos lo que se iba a hacer y cuánto iba a costar. El resultado fue excelente y el trato fue cercano en todo momento.",
  },
  {
    id: 2,
    name: "Carlos R.",
    ...
    text: "El cambio del baño fue rápido, limpio y muy bien organizado. Agradecimos contar con un equipo serio que cumplió siempre lo prometido.",
  },
  {
    id: 3,
    name: "Ana M.",
    ...
    text: "En la reforma integral fueron transparentes con el presupuesto y los tiempos. La comunicación fue fluida durante toda la obra y el resultado final nos encantó.",
  },
  {
    id: 4,
    name: "Pedro O.",
    ...
    text: "Muy profesionales. Nos ayudaron a planificar toda la reforma y resolvieron todas nuestras dudas durante el proceso.",
  },
  {
    id: 5,
    name: "Soraya G.",
    ...
    text: "Nos hicieron una reforma completa de baño y quedamos muy satisfechos con los acabados. Todo estuvo mejor organizado de lo que esperábamos.",
  },
] as const
