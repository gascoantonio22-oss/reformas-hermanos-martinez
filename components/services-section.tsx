      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center mb-20 section-fade-up">
          ...
          <p className="text-lg leading-relaxed text-[#51677c]">
            Diseñamos y ejecutamos tu reforma integrando todos los gremios y oficios necesarios.
            Así no tienes que preocuparte por nada: desde el diseño inicial hasta los acabados
            finales, garantizamos un proceso ordenado y una ejecución cuidada.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 section-fade-up-delayed">
          {selectedServices.map((service) => {
            ...
            return (
              <article
                key={service.slug}
                className="group relative flex flex-col overflow-hidden rounded-xl bg-white border border-black/[0.03] shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_25px_-5px_rgba(0,0,0,0.06)] hover:border-black/[0.05] transition-all duration-300 transform-gpu"
              >
        ...
        <div className="mx-auto mt-16 md:mt-20 max-w-3xl border-t border-[#1a2b3c]/10 pt-10 md:pt-12 text-center section-fade-up">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <p className="text-[15px] sm:text-base font-medium text-[#51677c]">
              ¿Buscas otro tipo de reforma o quieres ampliar tu proyecto?
            </p>
            <Link
              href="#contacto"
